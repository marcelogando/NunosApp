...
namespace Nunos2.Controls
{
    public class ExtendedMap : Xamarin.Forms.GoogleMaps.Map
    {
        public static readonly BindableProperty CalculateCommandProperty =
            BindableProperty.Create(nameof(CalculateCommand), typeof(ICommand), typeof(Views.MainPage), null, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty UpdateCommandProperty =
          BindableProperty.Create(nameof(UpdateCommand), typeof(ICommand), typeof(Views.MainPage), null, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty GetActualLocationCommandProperty =
          BindableProperty.Create(nameof(GetActualLocationCommand), typeof(ICommand), typeof(Views.MainPage), null, BindingMode.TwoWay);
